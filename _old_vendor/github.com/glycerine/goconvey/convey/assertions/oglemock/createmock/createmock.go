...
import (
	...
	_ "github.com/glycerine/goconvey/convey/assertions/oglemock/generate"
)
...
func run() error {
	...
	buildPkg, err := build.Import("github.com/glycerine/goconvey/convey/assertions/oglemock", "", build.FindOnly)
	if err != nil {
	...
	arg.Imports["generate"] = "github.com/glycerine/goconvey/convey/assertions/oglemock/generate"
	arg.Imports["log"] = "log"
	arg.Imports["os"] = "os"
